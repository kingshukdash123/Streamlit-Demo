...
ALLOWED_USERS = ['bittusp70@gmail.com']
...
if not st.user.is_logged_in:
    ...
    if st.user.email in ALLOWED_USERS:
        st.image(f"{st.user.picture}")
        st.success(f"Welcome {st.user.given_name} 🎉")
        st.write("✅ You have access to this app.")
        ...
        chai = st.selectbox("Your fav chai : ", ["Choose one...", "Masala Chai", "Adrak Chai", "Special Chai", "kesar Chai"], accept_new_options=True)
